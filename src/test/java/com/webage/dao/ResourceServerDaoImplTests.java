...
//         // Program WireMock.
//         // WHEN a GET to /customers occurs with a Bearer token in the Authorization
//         // header
...
//         Iterable<Customer> customers = client.findAllCustomers("FAKE_JWT");

//         // Our test data was only two customers:
//         assertNotNull(customers);
//         var customerList = Lists.newArrayList(customers);
//         assertThat(customerList.get(0).getProduct().equalsIgnoreCase("something"));
//     }
